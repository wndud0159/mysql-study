...
-- Exercise 01
SELECT series.id, title, AVG(rating) as avg_rating FROM series JOIN reviews ON series.id=reviews.series_id GROUP BY series.id, title ORDER BY avg_rating;
-- Exercise 02
...
WHERE title='Archer' OR
title='Arrested Development' OR
title="Bob's Burgers";
